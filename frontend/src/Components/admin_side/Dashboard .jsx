import { PaginatedSubscriptionTable } from './PaginatedSubscriptionTable ';
...
const Dashboard = () => {
  ...
  const getChartData = () => {
    if (selectedTimeframe === 'monthly') {
      return [{ name: 'Monthly Subscription Income', revenue: data.monthly_subscription_income }];
    } else if (selectedTimeframe === 'yearly') {
      return [{ name: 'Yearly Subscription Income', revenue: data.yearly_subscription_income }];
    }
  };
